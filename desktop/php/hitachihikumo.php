...
$plugin = plugin::byId('hitachihikumo');
...
<div class="row row-overflow">
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<div class="eqLogicThumbnailContainer">
			<div class="cursor eqLogicAction logoPrimary" data-action="discover">
				...
				<br>
				<span>{{Sync Hi-Kumo equipments}}</span>
			</div>
		...
		<legend><i class="fas fa-table"></i> {{My Hi-Kumo equipments}}</legend>
		<?php
		if (count($eqLogics) == 0) {
	...
	<!-- Equipment presentation page -->
	<div class="col-xs-12 eqLogic" style="display: none;">
		<!-- barre de gestion de l équipement -->
		<div class="input-group pull-right" style="display:inline-flex;">
			<span class="input-group-btn">
				<!-- Closing </a><a> tags to prevent spaces -->
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">{{ID}}
									<sup><i class="fas fa-question-circle tooltips" title="{{ID fetch from Hi-Kumo API (read-only)}}"></i></sup>
								</label>
								<div class="col-sm-6">
...
<?php include_file('desktop', 'hitachihikumo', 'js', 'hitachihikumo');?>
